...
// Constants
const EMAIL_CONFIG = {
  SENDER_NAME: "Advanced LMS Platform",
  ...
  return `
    ...
    <body style="margin: 0; padding: 20px; background-color: #f5f7fa;">
      <div class="email-container">
        ...
        <div class="footer">
          <p>&copy; ${new Date().getFullYear()} Advanced LMS Platform. All rights reserved.</p>
...
export const sendOTPEmail = async (email, otp, name) => {
  const content = `
    ...
    <div class="message">
      Welcome to Advanced LMS Platform! We're excited to have you join our learning community.
      <br><br>
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "🔐 Verify Your Email - Advanced LMS Platform",
...
export const sendWelcomeEmail = async (email, name) => {
  const content = `
    ...
    <div class="message">
      Congratulations on successfully joining Advanced LMS Platform! Your account has been verified and you're all set to begin your learning journey.
      <br><br>
  ...
  const mailOptions = {
    from: `"${EMAIL_CONFIG.SENDER_NAME}" <${EMAIL_CONFIG.SENDER_EMAIL}>`,
    to: email,
    subject: "🎉 Welcome to Advanced LMS Platform!",
...
export const sendPasswordResetEmail = async (email, name, resetToken) => {
  ...
  const mailOptions = {
    from: `"${EMAIL_CONFIG.SENDER_NAME}" <${EMAIL_CONFIG.SENDER_EMAIL}>`,
    to: email,
    subject: "🔐 Reset Your Password - Advanced LMS Platform",
    html: createEmailTemplate("Password Reset", content),
  };
